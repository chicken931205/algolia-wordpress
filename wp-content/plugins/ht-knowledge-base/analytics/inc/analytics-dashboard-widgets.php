	...
	class HKB_Analytics_Dashboard_Widgets {
		...
		function hkb_analytics_dashboard_widget_function(){
				...
				if ( $total_article_views ) {
					...
					printf( '<li class="%1$s-views hkb-analytics-dash-widget-views"><a href="edit.php?post_type=ht_kb&page=%3$s">%2$s</a></li>', 'feedback-stats', $total_article_views_text, HT_KB_ANALYTICS_REPORTING_PAGE_SLUG );					
				}
