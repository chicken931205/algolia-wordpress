...
if (!class_exists('HT_Knowledge_Base_Settings')) {
	...
	class HT_Knowledge_Base_Settings {
		...
		function __construct(){  
			...
			//@since 3.5
			//ht_kb_settings_set_default $id, $default
			add_action( 'ht_kb_settings_set_default', array($this, 'set_default'), 10, 2 );

		}

		function register_settings(){
			//will need updating to new signature - https://developer.wordpress.org/reference/functions/register_setting/ (currenly backwards compatible)
		...
		function add_ht_kb_settings_page(){
			...
			/*
			* Display meta not yet implemented
			// > Option: display-meta-dummy
			add_settings_field('display-meta-dummy', __('Article Meta', 'ht-knowledge-base'), array($this, 'article_display_meta_dummy_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');

			// > Option: display-meta-publish-date
			add_settings_field('display-meta-publish-date', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_publish_date_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-publish-date', true);

			// > Option: display-meta-last-updated
			add_settings_field('display-meta-last-updated', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_last_updated_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-last-updated', true);

			// > Option: display-meta-author
			add_settings_field('display-meta-author', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_author_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-author', true);

			// > Option: display-meta-views
			add_settings_field('display-meta-views', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_views_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-views', true);

			// > Option: display-meta-rating
			add_settings_field('display-meta-rating', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_rating_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-rating', true);

			// > Option: display-meta-comment-count
			add_settings_field('display-meta-comment-count', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_comment_count_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-comment-count', true);

			// > Option: display-meta-attachment-count
			add_settings_field('display-meta-attachment-count', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_attachment_count_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-attachment-count', true);

			// > Option: display-meta-reading-time
			add_settings_field('display-meta-reading-time', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_reading_time_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-reading-time', true);

			// > Option: display-meta-article-categories
			add_settings_field('display-meta-article-categories', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_comment_count_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-article-categories', true);

			// > Option: display-meta-article-tags
			add_settings_field('display-meta-article-tags', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_comment_count_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-article-tags', true);

			// > Option: display-meta-print-button
			add_settings_field('display-meta-print-button', __('', 'ht-knowledge-base'), array($this, 'article_display_meta_print_button_option_render'), 'ht_kb_settings_article_section', 'ht_knowledge_base_article_settings');
			$this->set_default('display-meta-print-button', true);
			*/
		...
		*/
		...
		function ht_kb_settings_display(){
			...
			$hkb_admin_settings_page_js_src = (HKB_DEBUG_SCRIPTS) ? 'js/hkb-admin-settings-page-js.js' : 'js/hkb-admin-settings-page-js.min.js';
				//need color picker assets
				wp_enqueue_style( 'wp-color-picker' );
				wp_enqueue_script( 'wp-color-picker');
				//enqueue media
				wp_enqueue_media();

			wp_enqueue_script( 'ht-kb-settings-page', plugins_url( $hkb_admin_settings_page_js_src, dirname(__FILE__) ), array( 'jquery', 'jquery-ui-core',  'jquery-ui-tabs', 'wp-color-picker' ), HT_KB_VERSION_NUMBER, true );              
			...
			//@since 3.4.0
			//remove the default archive posts names
			$kb_archive_post_names = ht_kb_get_registered_knowledge_base_archive_post_names();
			//note array_diff does not re-index the array
			$this->existing_post_names = array_diff( $this->existing_post_names, $kb_archive_post_names );
			...
			wp_localize_script( 'ht-kb-settings-page', 
								...
								array( 'reservedTerms' => $this->reserved_terms, 
									   'kbArchiveNames' => $kb_archive_post_names,
		...
		//dummy option render
		function article_display_meta_dummy_option_render(){
			_e('Article meta displayed at top of article', 'ht-knowledge-base');
		}

		//article meta - 'publish_date'
		function article_display_meta_publish_date_option_render(){
			if(!apply_filters('article_display_meta_publish_date_option_render', true)){
				echo apply_filters(
					'article_display_meta_publish_date_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-publish-date__input" name="ht_knowledge_base_settings[display-meta-publish-date]" value="1" <?php checked( $this->ht_kb_settings['display-meta-publish-date'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Publish Date', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'last_updated'
		function article_display_meta_last_updated_option_render(){
			if(!apply_filters('article_display_meta_last_updated_option_render', true)){
				echo apply_filters(
					'article_display_meta_last_updated_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-last-updated__input" name="ht_knowledge_base_settings[display-meta-last-updated]" value="1" <?php checked( $this->ht_kb_settings['display-meta-last-updated'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Last Updated', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'author'
		function article_display_meta_author_option_render(){
			if(!apply_filters('article_display_meta_author_option_render', true)){
				echo apply_filters(
					'article_display_meta_author_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-author__input" name="ht_knowledge_base_settings[display-meta-author]" value="1" <?php checked( $this->ht_kb_settings['display-meta-author'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Author', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'views'
		function article_display_meta_views_option_render(){
			if(!apply_filters('article_display_meta_views_option_render', true)){
				echo apply_filters(
					'article_display_meta_views_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-views__input" name="ht_knowledge_base_settings[display-meta-views]" value="1" <?php checked( $this->ht_kb_settings['display-meta-views'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Views', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'rating'
		function article_display_meta_rating_option_render(){
			if(!apply_filters('article_display_meta_rating_option_render', true)){
				echo apply_filters(
					'article_display_meta_rating_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-rating__input" name="ht_knowledge_base_settings[display-meta-rating]" value="1" <?php checked( $this->ht_kb_settings['display-meta-rating'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Rating', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'comment_count'
		function article_display_meta_comment_count_option_render(){
			if(!apply_filters('article_display_meta_comment_count_option_render', true)){
				echo apply_filters(
					'article_display_meta_comment_count_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-comment-count__input" name="ht_knowledge_base_settings[display-meta-comment-count]" value="1" <?php checked( $this->ht_kb_settings['display-meta-comment-count'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Comment Count', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'attachment_count'
		function article_display_meta_attachment_count_option_render(){
			if(!apply_filters('article_display_meta_attachment_count_option_render', true)){
				echo apply_filters(
					'article_display_meta_attachment_count_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-attachment-count__input" name="ht_knowledge_base_settings[display-meta-attachment-count]" value="1" <?php checked( $this->ht_kb_settings['display-meta-attachment-count'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Comment Count', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'reading_time'
		function article_display_meta_reading_time_option_render(){
			if(!apply_filters('article_display_meta_reading_time_option_render', true)){
				echo apply_filters(
					'article_display_meta_reading_time_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-reading-time__input" name="ht_knowledge_base_settings[display-meta-reading-time]" value="1" <?php checked( $this->ht_kb_settings['display-meta-reading-time'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Reading Time', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'ht_kb_categories'
		function article_display_meta_article_categories_option_render(){
			if(!apply_filters('article_display_meta_article_categories_option_render', true)){
				echo apply_filters(
					'article_display_meta_article_categories_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-article-categories__input" name="ht_knowledge_base_settings[display-meta-article-categories]" value="1" <?php checked( $this->ht_kb_settings['display-meta-article-categories'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Article Categories', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'ht_kb_tags'
		function article_display_meta_article_tags_option_render(){
			if(!apply_filters('article_display_meta_article_tags_option_render', true)){
				echo apply_filters(
					'article_display_meta_article_tags_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-article-tags__input" name="ht_knowledge_base_settings[display-meta-article-tags]" value="1" <?php checked( $this->ht_kb_settings['display-meta-article-tags'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Article Tags', 'ht-knowledge-base'); ?></span>                
			<?php
		}

		//article meta - 'ht_kb_print'
		function article_display_meta_print_button_option_render(){
			if(!apply_filters('print_display_meta_print_button_option_render', true)){
				echo apply_filters(
					'print_display_meta_print_button_option_render',
					esc_attr__( '-', 'ht-knowledge-base' )
				);
				return;
			} ?>
				<input type="checkbox" class="ht-knowledge-base-settings-display-meta-print-button__input" name="ht_knowledge_base_settings[display-meta-print-button]" value="1" <?php checked( $this->ht_kb_settings['display-meta-print-button'], 1 ); ?> />
				<span class="hkb_setting_desc hkb_setting_desc--inline"><?php _e('Print Button', 'ht-knowledge-base'); ?></span>                
			<?php
		}
		...
		function transfers_kb_transfer_url_option_render(){
			...
			if(!apply_filters('hkb_transfers_kb_transfer_url_option_render', true)){
				...
				<span class="hkb_setting_desc"><?php _e('Default location that users will be transferred to if no URL specified in the widget', 'ht-knowledge-base'); ?></span>      
			<?php
		}
		...
		function ht_knowledge_base_settings_validate($input){
			...
			if( isset($input['display-breadcrumbs']) && false !== $input['display-breadcrumbs'] ) {
			...
			if( isset($input['display-taxonomy-article-excerpt']) && false !== $input['display-taxonomy-article-excerpt'] ) {
			...
			if( isset($input['display-article-count']) && false !== $input['display-article-count'] ) {
			...
			if( isset($input['display-sub-cats']) && false !== $input['display-sub-cats'] ) {
			...
			if( isset($input['display-sub-cat-articles']) && false !== $input['display-sub-cat-articles'] ) {
			...
			if( isset($input['hide-empty-cats']) && false !== $input['hide-empty-cats'] ) {
			...
			if( isset($input['hide-uncat-articles']) && false !== $input['hide-uncat-articles'] ) {
			...
			if( isset($input['enable-article-comments']) && false !== $input['enable-article-comments'] ) {
			...
			if( isset($input['display-article-usefulness']) && false !== $input['display-article-usefulness'] ) {
			...
			if( isset($input['display-article-views-count']) && false !== $input['display-article-views-count'] ) {
			...
			if( isset($input['display-article-comment-count']) && false !== $input['display-article-comment-count'] ) {
			...
			if( isset($input['display-article-author']) && false !== $input['display-article-author'] ) {
			...
			if( isset($input['display-related-articles']) && false !== $input['display-related-articles'] ) {
				$output['display-related-articles'] = true;
			} else {
				$output['display-related-articles'] = false;
			}
			
			//boolean validate display-meta-publish-date
			if( isset($input['display-meta-publish-date']) && false !== $input['display-meta-publish-date'] ) {
				$output['display-meta-publish-date'] = true;
			} else {
				$output['display-meta-publish-date'] = false;
			}

			//boolean validate display-meta-last-updated
			if( isset($input['display-meta-last-updated']) && false !== $input['display-meta-last-updated'] ) {
				$output['display-meta-last-updated'] = true;
			} else {
				$output['display-meta-last-updated'] = false;
			}

			//boolean validate display-meta-author
			if( isset($input['display-meta-author']) && false !== $input['display-meta-author'] ) {
				$output['display-meta-author'] = true;
			} else {
				$output['display-meta-author'] = false;
			}

			//boolean validate display-meta-views
			if( isset($input['display-meta-views']) && false !== $input['display-meta-views'] ) {
				$output['display-meta-views'] = true;
			} else {
				$output['display-meta-views'] = false;
			}

			//boolean validate display-meta-rating
			if( isset($input['display-meta-rating']) && false !== $input['display-meta-rating'] ) {
				$output['display-meta-rating'] = true;
			} else {
				$output['display-meta-rating'] = false;
			}

			//boolean validate display-meta-comment-count
			if( isset($input['display-meta-comment-count']) && false !== $input['display-meta-comment-count'] ) {
				$output['display-meta-comment-count'] = true;
			} else {
				$output['display-meta-comment-count'] = false;
			}

			//boolean validate display-meta-attachment-count
			if( isset($input['display-meta-attachment-count']) && false !== $input['display-meta-attachment-count'] ) {
				$output['display-meta-attachment-count'] = true;
			} else {
				$output['display-meta-attachment-count'] = false;
			}

			//boolean validate display-meta-reading-time
			if( isset($input['display-meta-reading-time']) && false !== $input['display-meta-reading-time'] ) {
				$output['display-meta-reading-time'] = true;
			} else {
				$output['display-meta-reading-time'] = false;
			}

			//boolean validate display-meta-article-categories
			if( isset($input['display-meta-article-categories']) && false !== $input['display-meta-article-categories'] ) {
				$output['display-meta-article-categories'] = true;
			} else {
				$output['display-meta-article-categories'] = false;
			}

			//boolean validate display-meta-article-tags
			if( isset($input['display-meta-article-tags']) && false !== $input['display-meta-article-tags'] ) {
				$output['display-meta-article-tags'] = true;
			} else {
				$output['display-meta-article-tags'] = false;
			}

			//boolean validate display-meta-print-button
			if( isset($input['display-meta-print-button']) && false !== $input['display-meta-print-button'] ) {
				$output['display-meta-print-button'] = true;
			} else {
				$output['display-meta-print-button'] = false;
			}

			//boolean validate display-live-search
			if( isset($input['display-live-search']) && false !== $input['display-live-search'] ) {
			...
			if( isset($input['focus-live-search']) && false !== $input['focus-live-search'] ) {
			...
			if( isset($input['display-search-result-excerpt']) && false !== $input['display-search-result-excerpt'] ) {
			...
			if( isset($input['highlight-search-result-excerpt']) && false !== $input['highlight-search-result-excerpt'] ) {
			...
			if( isset($input['article-sticky-sidebar']) && false !== $input['article-sticky-sidebar'] ) {
			...
			if( isset($input['enable-kb-styling-sitewide']) && false !== $input['enable-kb-styling-sitewide'] ) {
			...
			if( isset($input['enable-article-feedback']) && false !== $input['enable-article-feedback'] ) {
			...
			if( isset($input['enable-anon-article-feedback']) && false !== $input['enable-anon-article-feedback'] ) {
			...
			if( isset($input['enable-upvote-article-feedback']) && false !== $input['enable-upvote-article-feedback'] ) {
			...
			if( isset($input['enable-downvote-article-feedback']) && false !== $input['enable-downvote-article-feedback'] ) {
			...
			if( isset($input['kb-transfer-new-window']) && false !== $input['kb-transfer-new-window'] ) {
