...
Refactored analytics to use latest components, please report any issues to support.

= 3.7.0 =

The articles widget now works with a custom sort order and the only display articles in same category option.

= 3.6.0 =

Plugins required for certain functionality are now packaged, to install and activate, please use the setup assistant after upgrade.
