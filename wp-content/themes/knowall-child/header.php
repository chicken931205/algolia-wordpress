	...
	<?php if ( is_front_page() || is_post_type_archive( 'ht_kb' ) || ( function_exists( 'ht_kb_is_ht_kb_front_page' ) && ht_kb_is_ht_kb_front_page() ) ) : ?>
		...
		<div class="ht-container">
			...
			<?php if ( '' != $ht_searchtitle ) : ?>
				<h2 class="site-header__title test"><?php echo esc_html( $ht_searchtitle ); ?></h2>
				<h3 id="page-header-tagline">Bureau of Special Education Appeals (BSEA) Decisions and Rulings</h3>
			<?php endif; ?>
